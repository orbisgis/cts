 ...
 * column<br> </p> <p> n blocks follow : Ils d�crivent la matrice suivant un
 * parcours en zigzag (gauche-droite pour les lignes paires et droite-gauche
 * pour les lignes impaires) commen�ant � la premi�re ligne et 3�me colonne.
 * <p>Chaque valeur cod�e repr�sente la diff�rence <br> (n-(n-1)) -
 * ((n-1)-(n-2)) c'est � dire la variation de la pente </p> <p> Description d'un
 * bloc 1er octet : entier repr�sentant le nombre de bits servant � stocker
 * chaque valeur<br> p octets : p = taille bloc x valeur stock�e dans le premier
 * octet / 8<br> Chaque groupe de nbBits sert � coder une valeur de la
 * matrice.<br> Le premier groupe du premier bloc repr�sente la 3eme colonne de
 * la premiere ligne.<br> C'est la diff�rence des diff�rences entre valeurs
 * successives qui est cod�e :<br> C3 = (valeur3-valeur2) -
 * (valeur2-valeur1)<br> Rappelons que le parcours des blocs d�crit la matrice
...
public class BleggGeographicGrid extends GeographicGrid {
    ...
    public static void compress(float[][] values,
        ...
        // La longueur du tableau est �gale � 2 (les deux premieres valeurs) +
        ...
        // Le tableau est rempli en parcourant le tableau de gauche � droite
        // pour les lignes paires et de droite � gauche pour les impaires
        for (int i = 0; i < nbl; i++) {
            for (int j = 0; j < nbc; j++) {
                if (i % 2 == 0) {
        ...
        try {
            for (int i = 0; i < (length - 2) / groupSize; i++) {
                ...
                // Clone le tableau et tri le clone pour d�terminer les extrema
    ...
    /**
     * <p>Champ de bits destin� � stocker des entiers sign�s sur une largeur
     * ajust�e au plus juste (0 < nombre de bits < 256).<br> Une s�rie de n
     * valeurs comprises entre -16 et 15 pourront par exemple �tre stock�es sur
     * n x 5 bits.<br> Les bits sont ordonn�s des bits de poids faible vers les
    ...
    static class NBitArray {
        ...
        /**
         * <p>Retourne la valeur stock�e sur nbBits � la position pos.<br> La
        ...
        /**
         * <p>Retourne la n-i�me valeur de size bits de large.<br> <ul> <li>Le
        ...
        /**
         * <p>Change le n-i�me groupe de nbBits bits en lui donnant la valeur
         * value. Seul les size bits affect�s au codage de cette valeur sont
         * chang�s.</p>
         */
        ...
        /**
         * <p>Change le n-i�me group de size bits en lui donnant la valeur
         * value. Seul les size bits affect�s au codage de cette valeur sont
         * chang�s.</p>
         */
