...
public final class AngleFormat {
	...
	/**
	 * <p>This is the pattern used to parse a string representing a DMSH angle.</p>
	 */
	 ...
	 *   <li>any character different from DMSH may be used to separate D, M and H</li>
	 * </ul>
	 * <p>Exemples :</p>
	 * <ul>
	 *   <li>latitude = #D� MM' SS.SSS\" H(N|S)  --> latitude = 45� 09' 56.897" S</li>
	 ...
	 * seconds / hemisphere).
	 * The parser is very flexible and can analyze strings as
	 * <ul>
	 * <li>2</li>
	 * <li>.2�</li>
	 * <li>-.2�</li>
