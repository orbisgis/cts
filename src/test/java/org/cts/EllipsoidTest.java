...
public class EllipsoidTest extends CTSTestCase {
    ...
    public void testSPHERE() {
        ...
        assertEquals(SPHERE.getName()+" DirectUTMCoeff0", SPHERE.getDirectUTMCoeff()[0], 1, tol);
        assertEquals(SPHERE.getName()+" DirectUTMCoeff2", SPHERE.getDirectUTMCoeff()[2], 0, tol);
        assertEquals(SPHERE.getName()+" DirectUTMCoeff3", SPHERE.getDirectUTMCoeff()[3], 0, tol);
        assertEquals(SPHERE.getName()+" DirectUTMCoeff4", SPHERE.getDirectUTMCoeff()[4], 0, tol);
        assertEquals(SPHERE.getName()+" InverseUTMCoeff0", SPHERE.getInverseUTMCoeff()[0], 1, tol);
        assertEquals(SPHERE.getName()+" InverseUTMCoeff1", SPHERE.getInverseUTMCoeff()[1], 0, tol);
        assertEquals(SPHERE.getName()+" InverseUTMCoeff2", SPHERE.getInverseUTMCoeff()[2], 0, tol);
        assertEquals(SPHERE.getName()+" InverseUTMCoeff3", SPHERE.getInverseUTMCoeff()[3], 0, tol);
        assertEquals(SPHERE.getName()+" InverseUTMCoeff4", SPHERE.getInverseUTMCoeff()[4], 0, tol);
    ...
    public void testGRS80() {
        ...
        assertEquals(GRS80.getName()+" DirectUTMCoeff0", GRS80.getDirectUTMCoeff()[0], 0.998324298423133, tol);
        assertEquals(GRS80.getName()+" DirectUTMCoeff1", GRS80.getDirectUTMCoeff()[1], 0.000836328036226, tol);
        assertEquals(GRS80.getName()+" DirectUTMCoeff2", GRS80.getDirectUTMCoeff()[2], 0.000000759577835, tol);
        assertEquals(GRS80.getName()+" DirectUTMCoeff3", GRS80.getDirectUTMCoeff()[3], 0.000000001195631, tol);
        assertEquals(GRS80.getName()+" DirectUTMCoeff4", GRS80.getDirectUTMCoeff()[4], 0.000000000002411, tol);
        assertEquals(GRS80.getName()+" InverseUTMCoeff0", GRS80.getInverseUTMCoeff()[0], 0.998324298423133, tol);
        assertEquals(GRS80.getName()+" InverseUTMCoeff1", GRS80.getInverseUTMCoeff()[1], 0.000837732168390, tol);
        assertEquals(GRS80.getName()+" InverseUTMCoeff2", GRS80.getInverseUTMCoeff()[2], 0.000000059058691, tol);
        assertEquals(GRS80.getName()+" InverseUTMCoeff3", GRS80.getInverseUTMCoeff()[3], 0.000000000167341, tol);
        assertEquals(GRS80.getName()+" InverseUTMCoeff4", GRS80.getInverseUTMCoeff()[4], 0.000000000000214, tol);
    ...
    public void testWGS84() {
        ...
        assertEquals(WGS84.getName()+" DirectUTMCoeff0", WGS84.getDirectUTMCoeff()[0], 0.998324298431344, tol);
        assertEquals(WGS84.getName()+" DirectUTMCoeff1", WGS84.getDirectUTMCoeff()[1], 0.000836328032136, tol);
        assertEquals(WGS84.getName()+" DirectUTMCoeff2", WGS84.getDirectUTMCoeff()[2], 0.000000759577828, tol);
        assertEquals(WGS84.getName()+" DirectUTMCoeff3", WGS84.getDirectUTMCoeff()[3], 0.000000001195631, tol);
        assertEquals(WGS84.getName()+" DirectUTMCoeff4", WGS84.getDirectUTMCoeff()[4], 0.000000000002411, tol);
        assertEquals(WGS84.getName()+" InverseUTMCoeff0", WGS84.getInverseUTMCoeff()[0], 0.998324298431344, tol);
        assertEquals(WGS84.getName()+" InverseUTMCoeff1", WGS84.getInverseUTMCoeff()[1], 0.000837732164286, tol);
        assertEquals(WGS84.getName()+" InverseUTMCoeff2", WGS84.getInverseUTMCoeff()[2], 0.000000059058691, tol);
        assertEquals(WGS84.getName()+" InverseUTMCoeff3", WGS84.getInverseUTMCoeff()[3], 0.000000000167341, tol);
        assertEquals(WGS84.getName()+" InverseUTMCoeff4", WGS84.getInverseUTMCoeff()[4], 0.000000000000214, tol);
    ...
    public void testINTERNATIONAL1924() {
        ...
        assertEquals(INTERNATIONAL1924.getName()+" DirectUTMCoeff0", INTERNATIONAL1924.getDirectUTMCoeff()[0], 0.998317208056044, tol);
        assertEquals(INTERNATIONAL1924.getName()+" DirectUTMCoeff1", INTERNATIONAL1924.getDirectUTMCoeff()[1], 0.000839860298581, tol);
        assertEquals(INTERNATIONAL1924.getName()+" DirectUTMCoeff2", INTERNATIONAL1924.getDirectUTMCoeff()[2], 0.000000766015487, tol);
        assertEquals(INTERNATIONAL1924.getName()+" DirectUTMCoeff3", INTERNATIONAL1924.getDirectUTMCoeff()[3], 0.000000001210871, tol);
        assertEquals(INTERNATIONAL1924.getName()+" DirectUTMCoeff4", INTERNATIONAL1924.getDirectUTMCoeff()[4], 0.000000000002452, tol);
        assertEquals(INTERNATIONAL1924.getName()+" InverseUTMCoeff0", INTERNATIONAL1924.getInverseUTMCoeff()[0], 0.998317208056044, tol);
        assertEquals(INTERNATIONAL1924.getName()+" InverseUTMCoeff1", INTERNATIONAL1924.getInverseUTMCoeff()[1], 0.000841276339049, tol);
        assertEquals(INTERNATIONAL1924.getName()+" InverseUTMCoeff2", INTERNATIONAL1924.getInverseUTMCoeff()[2], 0.000000059561925, tol);
        assertEquals(INTERNATIONAL1924.getName()+" InverseUTMCoeff3", INTERNATIONAL1924.getInverseUTMCoeff()[3], 0.000000000169477, tol);
        assertEquals(INTERNATIONAL1924.getName()+" InverseUTMCoeff4", INTERNATIONAL1924.getInverseUTMCoeff()[4], 0.000000000000218, tol);
    ...
    public void testBESSEL1841() {
        ...
        assertEquals(BESSEL1841.getName()+" DirectUTMCoeff0", BESSEL1841.getDirectUTMCoeff()[0], 0.998329312961632, tol);
        assertEquals(BESSEL1841.getName()+" DirectUTMCoeff1", BESSEL1841.getDirectUTMCoeff()[1], 0.000833829872269, tol);
        assertEquals(BESSEL1841.getName()+" DirectUTMCoeff2", BESSEL1841.getDirectUTMCoeff()[2], 0.000000755041298, tol);
        assertEquals(BESSEL1841.getName()+" DirectUTMCoeff3", BESSEL1841.getDirectUTMCoeff()[3], 0.000000001184931, tol);
        assertEquals(BESSEL1841.getName()+" DirectUTMCoeff4", BESSEL1841.getDirectUTMCoeff()[4], 0.000000000002382, tol);
        assertEquals(BESSEL1841.getName()+" InverseUTMCoeff0", BESSEL1841.getInverseUTMCoeff()[0], 0.998329312961632, tol);
        assertEquals(BESSEL1841.getName()+" InverseUTMCoeff1", BESSEL1841.getInverseUTMCoeff()[1], 0.000835225612852, tol);
        assertEquals(BESSEL1841.getName()+" InverseUTMCoeff2", BESSEL1841.getInverseUTMCoeff()[2], 0.000000058704089, tol);
        assertEquals(BESSEL1841.getName()+" InverseUTMCoeff3", BESSEL1841.getInverseUTMCoeff()[3], 0.000000000165841, tol);
        assertEquals(BESSEL1841.getName()+" InverseUTMCoeff4", BESSEL1841.getInverseUTMCoeff()[4], 0.000000000000211, tol);
    ...
    public void testCLARKE1866() {
        ...
        assertEquals(CLARKE1866.getName()+" DirectUTMCoeff0", CLARKE1866.getDirectUTMCoeff()[0], 0.998305681856014, tol);
        assertEquals(CLARKE1866.getName()+" DirectUTMCoeff1", CLARKE1866.getDirectUTMCoeff()[1], 0.000845602277093, tol);
        assertEquals(CLARKE1866.getName()+" DirectUTMCoeff2", CLARKE1866.getDirectUTMCoeff()[2], 0.000000776538529, tol);
        assertEquals(CLARKE1866.getName()+" DirectUTMCoeff3", CLARKE1866.getDirectUTMCoeff()[3], 0.000000001235921, tol);
        assertEquals(CLARKE1866.getName()+" DirectUTMCoeff4", CLARKE1866.getDirectUTMCoeff()[4], 0.000000000002520, tol);
        assertEquals(CLARKE1866.getName()+" InverseUTMCoeff0", CLARKE1866.getInverseUTMCoeff()[0], 0.998305681856014, tol);
        assertEquals(CLARKE1866.getName()+" InverseUTMCoeff1", CLARKE1866.getInverseUTMCoeff()[1], 0.000847037783186, tol);
        assertEquals(CLARKE1866.getName()+" InverseUTMCoeff2", CLARKE1866.getInverseUTMCoeff()[2], 0.000000060384587, tol);
        assertEquals(CLARKE1866.getName()+" InverseUTMCoeff3", CLARKE1866.getInverseUTMCoeff()[3], 0.000000000172988, tol);
        assertEquals(CLARKE1866.getName()+" InverseUTMCoeff4", CLARKE1866.getInverseUTMCoeff()[4], 0.000000000000224, tol);
    ...
    public void testCLARKE1880IGN() {
        ...
        assertEquals(CLARKE1880IGN.getName()+" DirectUTMCoeff0", CLARKE1880IGN.getDirectUTMCoeff()[0], 0.998296952190891, tol);
        assertEquals(CLARKE1880IGN.getName()+" DirectUTMCoeff1", CLARKE1880IGN.getDirectUTMCoeff()[1], 0.000849951016621, tol);
        assertEquals(CLARKE1880IGN.getName()+" DirectUTMCoeff2", CLARKE1880IGN.getDirectUTMCoeff()[2], 0.000000784556140, tol);
        assertEquals(CLARKE1880IGN.getName()+" DirectUTMCoeff3", CLARKE1880IGN.getDirectUTMCoeff()[3], 0.000000001255122, tol);
        assertEquals(CLARKE1880IGN.getName()+" DirectUTMCoeff4", CLARKE1880IGN.getDirectUTMCoeff()[4], 0.000000000002572, tol);
        assertEquals(CLARKE1880IGN.getName()+" InverseUTMCoeff0", CLARKE1880IGN.getInverseUTMCoeff()[0], 0.998296952190891, tol);
        assertEquals(CLARKE1880IGN.getName()+" InverseUTMCoeff1", CLARKE1880IGN.getInverseUTMCoeff()[1], 0.000851401353949, tol);
        assertEquals(CLARKE1880IGN.getName()+" InverseUTMCoeff2", CLARKE1880IGN.getInverseUTMCoeff()[2], 0.000000061011443, tol);
        assertEquals(CLARKE1880IGN.getName()+" InverseUTMCoeff3", CLARKE1880IGN.getInverseUTMCoeff()[3], 0.000000000175680, tol);
        assertEquals(CLARKE1880IGN.getName()+" InverseUTMCoeff4", CLARKE1880IGN.getInverseUTMCoeff()[4], 0.000000000000228, tol);
    ...
    public void testCLARKE1880RGS() {
        ...
        assertEquals(CLARKE1880RGS.getName()+" DirectUTMCoeff0", CLARKE1880RGS.getDirectUTMCoeff()[0], 0.998296946266614, tol);
        assertEquals(CLARKE1880RGS.getName()+" DirectUTMCoeff1", CLARKE1880RGS.getDirectUTMCoeff()[1], 0.000849953967810, tol);
        assertEquals(CLARKE1880RGS.getName()+" DirectUTMCoeff2", CLARKE1880RGS.getDirectUTMCoeff()[2], 0.000000784561595, tol);
        assertEquals(CLARKE1880RGS.getName()+" DirectUTMCoeff3", CLARKE1880RGS.getDirectUTMCoeff()[3], 0.000000001255135, tol);
        assertEquals(CLARKE1880RGS.getName()+" DirectUTMCoeff4", CLARKE1880RGS.getDirectUTMCoeff()[4], 0.000000000002572, tol);
        assertEquals(CLARKE1880RGS.getName()+" InverseUTMCoeff0", CLARKE1880RGS.getInverseUTMCoeff()[0], 0.998296946266614, tol);
        assertEquals(CLARKE1880RGS.getName()+" InverseUTMCoeff1", CLARKE1880RGS.getInverseUTMCoeff()[1], 0.000851404315229, tol);
        assertEquals(CLARKE1880RGS.getName()+" InverseUTMCoeff2", CLARKE1880RGS.getInverseUTMCoeff()[2], 0.000000061011869, tol);
        assertEquals(CLARKE1880RGS.getName()+" InverseUTMCoeff3", CLARKE1880RGS.getInverseUTMCoeff()[3], 0.000000000175682, tol);
        assertEquals(CLARKE1880RGS.getName()+" InverseUTMCoeff4", CLARKE1880RGS.getInverseUTMCoeff()[4], 0.000000000000228, tol);
    ...
    public void testCLARKE1880ARC() {
        ...
        assertEquals(CLARKE1880ARC.getName()+" DirectUTMCoeff0", CLARKE1880ARC.getDirectUTMCoeff()[0], 0.998296953852258, tol);
        assertEquals(CLARKE1880ARC.getName()+" DirectUTMCoeff1", CLARKE1880ARC.getDirectUTMCoeff()[1], 0.000849950189008, tol);
        assertEquals(CLARKE1880ARC.getName()+" DirectUTMCoeff2", CLARKE1880ARC.getDirectUTMCoeff()[2], 0.000000784554611, tol);
        assertEquals(CLARKE1880ARC.getName()+" DirectUTMCoeff3", CLARKE1880ARC.getDirectUTMCoeff()[3], 0.000000001255118, tol);
        assertEquals(CLARKE1880ARC.getName()+" DirectUTMCoeff4", CLARKE1880ARC.getDirectUTMCoeff()[4], 0.000000000002572, tol);
        assertEquals(CLARKE1880ARC.getName()+" InverseUTMCoeff0", CLARKE1880ARC.getInverseUTMCoeff()[0], 0.998296953852258, tol);
        assertEquals(CLARKE1880ARC.getName()+" InverseUTMCoeff1", CLARKE1880ARC.getInverseUTMCoeff()[1], 0.000851400523506, tol);
        assertEquals(CLARKE1880ARC.getName()+" InverseUTMCoeff2", CLARKE1880ARC.getInverseUTMCoeff()[2], 0.000000061011323, tol);
        assertEquals(CLARKE1880ARC.getName()+" InverseUTMCoeff3", CLARKE1880ARC.getInverseUTMCoeff()[3], 0.000000000175679, tol);
        assertEquals(CLARKE1880ARC.getName()+" InverseUTMCoeff4", CLARKE1880ARC.getInverseUTMCoeff()[4], 0.000000000000228, tol);
    ...
    public void testKRASSOWSKI() {
        ...
        assertEquals(KRASSOWSKI.getName()+" DirectUTMCoeff0", KRASSOWSKI.getDirectUTMCoeff()[0], 0.998324538627092, tol);
        assertEquals(KRASSOWSKI.getName()+" DirectUTMCoeff1", KRASSOWSKI.getDirectUTMCoeff()[1], 0.000836208371027, tol);
        assertEquals(KRASSOWSKI.getName()+" DirectUTMCoeff2", KRASSOWSKI.getDirectUTMCoeff()[2], 0.000000759360219, tol);
        assertEquals(KRASSOWSKI.getName()+" DirectUTMCoeff3", KRASSOWSKI.getDirectUTMCoeff()[3], 0.000000001195117, tol);
        assertEquals(KRASSOWSKI.getName()+" DirectUTMCoeff4", KRASSOWSKI.getDirectUTMCoeff()[4], 0.000000000002409, tol);
        assertEquals(KRASSOWSKI.getName()+" InverseUTMCoeff0", KRASSOWSKI.getInverseUTMCoeff()[0], 0.998324538627092, tol);
        assertEquals(KRASSOWSKI.getName()+" InverseUTMCoeff1", KRASSOWSKI.getInverseUTMCoeff()[1], 0.000837612100648, tol);
        assertEquals(KRASSOWSKI.getName()+" InverseUTMCoeff2", KRASSOWSKI.getInverseUTMCoeff()[2], 0.000000059041681, tol);
        assertEquals(KRASSOWSKI.getName()+" InverseUTMCoeff3", KRASSOWSKI.getInverseUTMCoeff()[3], 0.000000000167269, tol);
        assertEquals(KRASSOWSKI.getName()+" InverseUTMCoeff4", KRASSOWSKI.getInverseUTMCoeff()[4], 0.000000000000214, tol);
