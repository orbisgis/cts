 ...
 */
public class CirceAntilleGuyaneComplianceTest extends BaseCoordinateTransformTest {

    public static final GeographicExtent GUYANE = new GeographicExtent("Guyane Française", 2.05, 5.95, -54.95, -51.05);

    // ////////////////////////////////////////////////////////////////////////
    // DATUM
    // ////////////////////////////////////////////////////////////////////////
    static GeodeticDatum FORT_DESAIX = GeodeticDatum.createGeodeticDatum(
    ...
    static GeodeticDatum RRAF_MTQ = GeodeticDatum.createGeodeticDatum(
    ...
    static GeodeticDatum STE_ANNE = GeodeticDatum.createGeodeticDatum(
    ...
    static GeodeticDatum RRAF_GUA = GeodeticDatum.createGeodeticDatum(
    ...
    static GeodeticDatum FORT_MARIGOT = GeodeticDatum.createGeodeticDatum(
    ...
    static GeodeticDatum RRAF_SBSM = GeodeticDatum.createGeodeticDatum(
    ...
    static GeodeticDatum CSG1967 = GeodeticDatum.createGeodeticDatum(
    ...
    static GeodeticDatum RGAF09 = GeodeticDatum.createGeodeticDatum(
    ...
    static GeodeticDatum RGFG95 = GeodeticDatum.createGeodeticDatum(
    ...
    // Martinique
    static final GeodeticCRS FORT_DESAIX_GEO2D = new Geographic2DCRS(new Identifier("IGNF","Fort Desaix Geo2D", "Fort Desaix Geo2D"), FORT_DESAIX);

    static final GeodeticCRS FORT_DESAIX_UTM20 = new ProjectedCRS(new Identifier("IGNF","Fort Desaix UTM 20N", "Fort Desaix UTM 20N"),
            FORT_DESAIX, UniversalTransverseMercator.createUTM(Ellipsoid.INTERNATIONAL1924, 20, "NORTH"));

    static final GeodeticCRS RRAF_MTQ_GEO2D = new Geographic2DCRS(new Identifier("IGNF","RRAF MTQ Geo2D", "RRAF MTQ Geo2D"), RRAF_MTQ);

    static final GeodeticCRS RRAF_MTQ_GEO3D = new Geographic3DCRS(new Identifier("IGNF","RRAF MTQ Geo3D", "RRAF MTQ Geo3D"), RRAF_MTQ);

    static final GeodeticCRS RRAF_MTQ_UTM20 = new ProjectedCRS(new Identifier("IGNF","RRAF (MTQ) UTM 20N", "RRAF (MTQ) UTM 20N"),
            RRAF_MTQ, UniversalTransverseMercator.createUTM(Ellipsoid.GRS80, 20, "NORTH"));

    static CompoundCRS RRAF_MTQ_UTM20_HE = null;
    static {
    ...
    static CompoundCRS FORT_DESAIX_IGN1987 = null;
    static {
    ...
    // Guadeloupe
    static final GeodeticCRS STE_ANNE_GEO2D = new Geographic2DCRS(new Identifier("IGNF","Sainte-Anne Geo2D", "Sainte-Anne Geo2D"), STE_ANNE);

    static final GeodeticCRS STE_ANNE_UTM20 = new ProjectedCRS(new Identifier("IGNF","STE_ANNE UTM 20N", "STE_ANNE UTM 20N"),
            STE_ANNE, UniversalTransverseMercator.createUTM(Ellipsoid.INTERNATIONAL1924, 20, "NORTH"));

    static final GeodeticCRS RRAF_GUA_GEO2D = new Geographic2DCRS(new Identifier("IGNF","RRAF GUA Geo2D", "RRAF GUA Geo2D"), RRAF_GUA);
    ...
    static CompoundCRS RRAF_GUA_UTM20_HE = null;
    static {
    ...
    static CompoundCRS STE_ANNE_IGN1988_GTBT = null;
    static {
    ...
    static final GeodeticCRS FORT_MARIGOT_GEO2D = new Geographic2DCRS(new Identifier("IGNF","Fort Marigot Geo2D", "Fort Marigot Geo2D"), FORT_MARIGOT);

    static final GeodeticCRS FORT_MARIGOT_UTM20 = new ProjectedCRS(new Identifier("IGNF","FORT_MARIGOT UTM 20N", "FORT_MARIGOT UTM 20N"),
            FORT_MARIGOT, UniversalTransverseMercator.createUTM(Ellipsoid.INTERNATIONAL1924, 20, "NORTH"));

    static final GeodeticCRS RRAF_SBSM_GEO2D = new Geographic2DCRS(new Identifier("IGNF","RRAF SBSM Geo2D", "RRAF SBSM Geo2D"), RRAF_SBSM);
    ...
    static CompoundCRS FORT_MARIGOT_IGN1988_SB = null;
    static {
    ...
    // GUYANE
    static final GeodeticCRS CSG1967_GEO2D = new Geographic2DCRS(new Identifier("IGNF","CSG67G", "CSG 1967 Geo2D"), CSG1967);

    static final GeodeticCRS CSG1967_UTM22 = new ProjectedCRS(new Identifier("IGNF","CSG1967 UTM 22N", "CSG1967 UTM 22N"),
    ...
    static final GeodeticCRS RGFG95_GEO3D = new Geographic3DCRS(new Identifier("IGNF","RGFG95 Geo3D", "RGFG95 Geo3D"), RGFG95);

    static final GeodeticCRS RGFG95_UTM22 = new ProjectedCRS(new Identifier("IGNF","RGFG95 UTM 22N", "RGFG95 UTM 22N"),
            RGFG95, UniversalTransverseMercator.createUTM(Ellipsoid.GRS80, 22, "NORTH"));

    static GeodeticCRS RGFG95_UTM22_HE = null;
    static {
    ...
    static GeodeticCRS CSG1967_GUYA77 = null;
    static {
    ...
    static final GeodeticCRS RGAF09_GEO3D = new Geographic3DCRS(new Identifier("IGNF","RGAF09 Geo3D", "RGAF09 Geo3D"), RGAF09);

    static final GeodeticCRS RGAF09_UTM20 = new ProjectedCRS(new Identifier("IGNF","RGAF09 UTM 20N", "RGAF09 UTM 20N"),
            RGAF09, UniversalTransverseMercator.createUTM(Ellipsoid.GRS80, 20, "NORTH"));

    static CompoundCRS RGAF09_UTM20_HE = null;
    static {
    ...
    @Test
    public void testFORT_DESAIX_to_FORT_DESAIX()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{14.5, -61.0}, FORT_DESAIX_GEO2D, FORT_DESAIX_UTM20, new double[]{715553.632, 1603986.075}, MM_IN_DEG, MM);
    }

    @Test
    public void testFORT_DESAIX_to_RGAF09_GEO3D()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{14.5, -61.0}, FORT_DESAIX_GEO2D, RGAF09_GEO3D, new double[]{14.50166751, -60.99633191, 0}, MM_IN_DEG, MM_IN_DEG);
    }

    @Test
    public void testFORT_DESAIX_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{14.5, -61.0}, FORT_DESAIX_GEO2D, RGAF09_UTM20_HE, new double[]{715938.802, 1604155.162, 0}, MM_IN_DEG, MM);
    }

    @Test
    public void testWGS84_MTQ_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{14.5, -61.0}, RRAF_MTQ_GEO2D, RGAF09_UTM20_HE, new double[]{715544.290, 1603967.149, 0}, MM_IN_DEG, MM);
    }

    @Test
    public void testFORT_DESAIX_IGN1987_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    public void testSTE_ANNE_to_STE_ANNE()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{16.0, -61.5}, STE_ANNE_GEO2D, STE_ANNE_UTM20, new double[]{660509.501, 1769535.756}, MM_IN_DEG, MM);
    }

    @Test
    public void testSTE_ANNE_to_RGAF09_GEO3D()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{16.0, -61.5}, STE_ANNE_GEO2D, RGAF09_GEO3D, new double[]{15.99747584, -61.50391185, 0}, MM_IN_DEG, MM_IN_DEG);
    }

    @Test
    public void testSTE_ANNE_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{16.0, -61.5}, STE_ANNE_GEO2D, RGAF09_UTM20_HE, new double[]{660086.365, 1769232.273, 0}, MM_IN_DEG, MM);
    }

    @Test
    public void testWGS84_GUA_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{16.0, -61.5}, RRAF_GUA_GEO2D, RGAF09_UTM20_HE, new double[]{660502.424, 1769514.648, 0}, MM_IN_DEG, MM);
    }

    @Test
    public void testSTE_ANNE_IGN1988_GTBT_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    public void testFORT_MARIGOT_to_FORT_MARIGOT()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{18.0, -62.8}, FORT_MARIGOT_GEO2D, FORT_MARIGOT_UTM20, new double[]{521173.421, 1990221.324}, MM_IN_DEG, MM);
    }

    @Test
    public void testFORT_MARIGOT_to_RGAF09_GEO3D()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{18.0, -62.8}, FORT_MARIGOT_GEO2D, RGAF09_GEO3D, new double[]{17.99626623, -62.79778742, 0}, MM_IN_DEG, MM_IN_DEG);
    }

    @Test
    public void testFORT_MARIGOT_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{18.0, -62.8}, FORT_MARIGOT_GEO2D, RGAF09_UTM20_HE, new double[]{521407.240, 1989784.123, 0}, MM_IN_DEG, MM);
    }

    @Test
    public void testWGS84_SBSM_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{18.0, -62.8}, RRAF_SBSM_GEO2D, RGAF09_UTM20_HE, new double[]{521171.969, 1990197.114, 0}, MM_IN_DEG, MM);
    }

    @Test
    public void testFORT_MARIGOT_IGN88SB_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    public void testCSG1967_to_CSG1967()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.9, -52.3}, CSG1967_GEO2D, CSG1967_UTM22, new double[]{355849.751, 541756.113}, MM_IN_DEG, MM);
    }

    @Test
    public void testCSG1967_to_RGFG95_GEO3D()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.9, -52.3}, CSG1967_GEO2D, RGFG95_GEO3D, new double[]{4.90107745, -52.30005723, 0}, MM_IN_DEG, MM_IN_DEG);
    }

    @Test
    public void testCSG1967_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.9, -52.3}, CSG1967_GEO2D, RGFG95_UTM22_HE, new double[]{355849.323, 541869.306, 0}, MM_IN_DEG, MM);
    }

    @Test
    public void testCSG1967_GUYA77_to_RGAF09_UTM20_HE()  throws IllegalCoordinateException, CoordinateOperationException {
