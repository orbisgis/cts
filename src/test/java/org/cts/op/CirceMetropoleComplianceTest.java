 ...
 */
class CirceMetropoleComplianceTest extends BaseCoordinateTransformTest {
    ...
    // Projected CRS
    // ------------------------------------------------------------------------
    private static CompoundCRS LAMBE_IGN69;
    private static CompoundCRS LAMBE_IGN78;
    private static CompoundCRS LAMB93_IGN69;
    private static CompoundCRS LAMB93_IGN78;
    private static CompoundCRS LAMB93_RGF93_HEIGHT;
    private static CompoundCRS LAMBERT_CC42_IGN69;
    private static CompoundCRS LAMBERT_CC43_IGN69;

    private static CompoundCRS NTF_P_GEO2D_EGM2008;
    private static CompoundCRS NTF_P_GEO2D_IGN69;
    private static CompoundCRS ED50_GEO2D_EGM2008;
    private static CompoundCRS WGS_UTM31N_EGM2008;
    ...
    @Test
    void testNTF_P_GEO2D_To_LAMBERT3() throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    void testNTF_P_GEO2D_To_WGS84_CARTESIAN() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{0, 50}, NTF_P_GEO2D, WGS84_CARTESIAN, new double[]{4513867.678, 184180.302, 4487377.241}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_G_GEO2D_To_WGS84_GEO2D() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{0,50}, NTF_G_GEO2D, WGS84_GEO2D, new double[]{-0.00076096, 44.99996000}, MM_IN_DEG, MM_IN_DEG);
    }

    @Test
    void testNTF_P_GEO2D_To_WGS84_GEO2D() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{0,50}, NTF_P_GEO2D, WGS84_GEO2D, new double[]{2.33655573, 44.99997468}, MM_IN_DEG, MM_IN_DEG);
    }

    @Test
    void testNTF_P_GEO2D_To_WGS84_LAMBERT_OACI() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{0, 50}, NTF_P_GEO2D, LAMB_OACI_DECCA, new double[]{687249.051, 222917.435}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_P_GEO2D_To_WGS84_UTM_31N() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{0, 50}, NTF_P_GEO2D, WGS_UTM31N, new double[]{447710.418, 4983161.661}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_P_GEO2D_EGM2008_To_WGS84_C() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{0, 50, 0}, NTF_P_GEO2D_EGM2008, WGS84_CARTESIAN, new double[]{4513873.110, 184180.524, 4487382.677}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_P_GEO2D_EGM2008_To_WGS84_GEO3D() throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    void testNTF_P_GEO2D_To_ED50_GEO2D() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{-1, 50}, NTF_P_GEO2D, ED50_GEO2D, new double[]{1.43772499, 45.00098603}, MM_IN_DEG, MM_IN_DEG);
    }


    @Test
    void testNTF_P_GEO2D_EGM2008_To_ED50_GEO3D() throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    void testED50_GEO2D_To_NTF_GEO2D() throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    void testED50_GEO2D_EGM2008_To_WGS_UTM31_EGM2008() throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    void testNTF_G_GEO2D_to_NTF_LAMBERT_GC() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.8, 48}, NTF_P_GEO2D, LAMBGC, new double[]{951494.057, 187341.695}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_P_GEO2D_to_NTF_LAMBERT_GC() throws IllegalCoordinateException, CoordinateOperationException {
    ...
    @Test
    void testNTF_P_GEO2D_to_RGF93_CARTESIAN() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.8, 48}, NTF_P_GEO2D, RGF93_CARTESIAN, new double[]{4625404.758, 539819.798, 4343756.349}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_P_GEO2D_IGN69_to_RGF93_CARTESIAN() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.8, 48, 100}, NTF_P_GEO2D_IGN69, RGF93_CARTESIAN, new double[]{4625481.991, 539828.812, 4343829.368}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_P_GEO2D_G_to_LAMBERT93() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.8, 48}, NTF_P_GEO2D, LAMB93, new double[]{997304.067, 6240309.718}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_P_GEO2D_IGN69_to_LAMBERT93_RGF93_HEIGHT() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.8, 48, 100}, NTF_P_GEO2D_IGN69, LAMB93_RGF93_HEIGHT, new double[]{997304.067, 6240309.718, 147.722}, MM_IN_DEG, MM);
    }

    @Test
    void testNTF_P_GEO2D_IGN69_to_LAMBERT93_IGN69() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{4.8, 48, 100}, NTF_P_GEO2D_IGN69, LAMB93_IGN69, new double[]{997304.067, 6240309.718, 100}, MM_IN_DEG, MM);
    }

    @Test
    void testLAMBE_to_LAMBERT93() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{900000, 1800000}, LAMBE, LAMB93, new double[]{945698.924, 6231380.043}, MM, MM);
    }

    @Test
    void testLAMBE_IGN69_to_LAMBERT93_RGF93_HEIGHT() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{900000, 1800000, 1000}, LAMBE_IGN69, LAMB93_RGF93_HEIGHT, new double[]{945698.930, 6231380.043, 1048.594}, MM, MM);
    }

    @Test
    void testLAMBE_IGN69_to_LAMBERT_CC42_IGN69() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{900000, 1800000, 100}, LAMBE_IGN69, LAMBERT_CC42_IGN69, new double[]{1945550.945, 1330895.995, 100}, MM, MM);
    }

    @Test
    void testLAMBE_IGN69_to_LAMBERT_CC43_IGN69() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{900000, 1800000, 100}, LAMBE_IGN69, LAMBERT_CC43_IGN69, new double[]{1945501.135, 2219896.534, 100}, MM, MM);
    }

    @Test
    void testLAMBE_to_ETRS_LCC() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{900000, 1800000}, LAMBE, ETRS_LCC, new double[]{3684671.410, 1854821.809}, MM, MM);
    }

    @Test
    void testLAMBE_to_ETRS_LAEA() throws IllegalCoordinateException, CoordinateOperationException {
        test(new double[]{900000, 1800000}, LAMBE, ETRS89_LAEA, new double[]{3996336.163, 2234361.507}, MM, MM);
    }

    @Test
    void testLAMBE_to_ETRS_UTM32N() throws IllegalCoordinateException, CoordinateOperationException {
