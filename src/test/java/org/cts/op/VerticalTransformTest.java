...
public class VerticalTransformTest extends BaseCoordinateTransformTest {
    ...
    public void testVerticalGrid() throws Exception {
        InputStream is = IGNVerticalGrid.class.getClassLoader().getResourceAsStream("org/cts/op/transformation/grids/RAF09.txt");
        IGNVerticalGrid grid = new IGNVerticalGrid(is, false);
        double[] result = grid.bilinearInterpolation(51.5, -5.5);
        assertTrue(result.length == 1);
        assertTrue(result[0] == 53.5019);
    }
}
